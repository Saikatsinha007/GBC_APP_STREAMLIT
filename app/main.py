...
model = pickle.load(open("C:/Users/EJ312WS/Downloads/TMC/TMC/lightgbm_model.pkl", "rb"))
scaler = pickle.load(open("C:/Users/EJ312WS/Downloads/TMC/TMC/scaler.pkl", "rb"))
onehot_encoder = pickle.load(open("C:/Users/EJ312WS/Downloads/TMC/TMC/onehot_encoder.pkl", "rb"))
...
def get_clean_data():
    data = pd.read_excel("C:/Users/EJ312WS/Downloads/TMC/TMC/sem2_working_gbc_clean_final.xlsx")
    return data
